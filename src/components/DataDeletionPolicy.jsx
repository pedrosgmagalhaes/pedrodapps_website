      ...
      <div className="policy__container">
        <div className="policy__card" role="article" aria-describedby="policy-desc">
          <header>
            ...
            <p id="policy-desc" className="policy__subtitle">Procedimentos, prazos e controles para exclusão de dados pessoais.</p>
          </header>

          {/* 1. Solicitação de exclusão */}
          <div className="policy__section">
            <p><strong>Solicitação de exclusão</strong></p>
            <ul>
          ...
          {/* 2. Prazo e escopo */}
          <div className="policy__section">
            <p><strong>Prazo e escopo</strong></p>
            <ul>
          ...
          <div className="policy__section">
            <p><strong>Exceções e retenções legais</strong></p>
            <ul>
              <li>Registros de transação e documentos fiscais podem ser mantidos conforme exigências legais.</li>
              <li>Backups operacionais podem reter dados por prazo adicional estritamente técnico.</li>
            </ul>
          </div>

          {/* 4. Efeitos da exclusão */}
          <div className="policy__section">
            <p><strong>Efeitos da exclusão</strong></p>
            <ul>
          ...
          <div className="policy__section">
            <p><strong>Segurança e verificação</strong></p>
            <p>
              O processo de exclusão emprega controles de segurança e validação de identidade para prevenir acessos indevidos.
            </p>
          </div>
