        ...
        <div className="policy__card" role="article" aria-describedby="policy-desc">
          <header>
            ...
            <p id="policy-desc" className="policy__subtitle">
              Como utilizamos cookies para melhorar a experiência, com transparência e controle.
            </p>
          </header>
          ...
          <div className="policy__section">
            ...
            <p>
              ...
              preferências, manter sessões ativas e melhorar a navegação. Também podem ser usados
              para métricas de uso e exibição de conteúdo relevante.
            </p>
          </div>
          ...
          <div className="policy__section">
            <p>
              <strong>Cookies que podemos utilizar</strong>
            </p>
            <ul>
              ...
              <li>
                Publicidade por parceiros, como o cookie DoubleClick para anúncios relevantes e
                limitação de repetição.
              </li>
            </ul>
            <p>
          ...
          <div className="policy__section">
            <p>
              <strong>Gerenciamento de cookies</strong>
            </p>
            <p>
              Você pode gerenciar e excluir cookies nas configurações do seu navegador. Alguns
              recursos podem não funcionar corretamente sem determinados cookies.
            </p>
            <ul>
          ...
          <div className="policy__section">
            <p>
              <strong>Atualizações e contato</strong>
            </p>
            <p>
              Esta política pode ser atualizada para refletir melhorias e requisitos legais. Em caso
              de dúvidas, entre em contato pelo e-mail de suporte informado no site.
            </p>
          </div>
