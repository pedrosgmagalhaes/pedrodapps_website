# Ecossistema Pixley – Documento Completo

## 1. Visão Geral

A Pixley Wallet é um ecossistema integrado que conecta usuários brasileiros ao universo DeFi, permitindo depósitos e saques em reais via PIX, execução de scripts automatizados, criação e deploy de smart contracts, participação em comunidade premium e acesso a ferramentas avançadas.
...
## 2. Estrutura de Planos – Pixley Wallet

### **FREE – Usuário Básico (Gratuito)**

**Objetivo:** permitir testes e validar usuário, limitando risco e incentivando upgrade.
...
### **STANDARD – Plano Intermediário (R$49/mês)**

**Objetivo:** servir como ponte psicológica para o upgrade ao Premium.
...
### **PREMIUM – Pixley Builder Club (R$657/mês)**

**Objetivo:** entregar o máximo valor, aumentar LTV e reduzir churn.
...
## 3. Scripts e Automações Disponíveis
...
Entrega personalizada de automação ou smart contract.

### **2. Deploy Assistido Premium**

Deploy completo de token, LP, segurança, anti-bot.

### **3. Mentoria 1:1 (Criação de Token / Projeto)**

2–3 encontros, entrega final segura.

### **4. Dashboard Web3 Personalizado**

Monitor de pools, alertas, whales, LP.

### **5. Builder PRO Pack**

Pacote com 5 scripts para necessidades específicas.
...
## 7. Política de Tarifas Consolidada

**Todas as tarifas descritas a seguir já estão incluídas no pacote de uso da Pixley Wallet para cada plano correspondente (Free, Standard e Premium). Não há cobrança adicional oculta.**

| Plano    | % Transação | Tarifa Fixa | Depósito/dia   | Saque/dia      |
| -------- | ----------- | ----------- | -------------- | -------------- |
| Free     | **2%**      | R$5         | R$500          | R$300          |
| Standard | **1%**      | R$2         | R$2.000        | R$1.000        |
| Premium  | **0.80%**   | R$1         | R$5.000–20.000 | R$3.000–15.000 |

---

## 8. Posicionamento Final

A Pixley Wallet não é apenas uma carteira.
É um **ecossistema completo de automação DeFi para brasileiros**, com entrada e saída via PIX, scripts profissionais e comunidade de alta performance.
...
## 9. Proposta Final de Branding

**Pixley – A ponte brasileira para o DeFi profissional.**

Deposite. Automatize. Lucre. Saque. Tudo em um só lugar.
